...
Then, set your provider key (DashScope/SiliconFlow OpenAI-compatible API):
...
- `SiliconFlowInferenceEngine` (DashScope-compatible OpenAI SDK client)
- `SiliconFlowEmbeddingEngine` (DashScope-compatible OpenAI SDK client)
- `HNSWLibVectorDB`
- `InMemoryEmbeddingMetadataStorage`
- `NoEvictionPolicy`
