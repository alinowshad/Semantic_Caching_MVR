...
class MaxSimSplitter:
    ...
    def split_pair_return_maxsim_tensors_from_encoded(self, enc_a: dict, enc_b: dict) -> tuple:
        ...
        def _segment_embeds(token_emb: torch.Tensor, length: int, pointers: list) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        sent_a, full_a = _segment_embeds(tok_a, la, pointers_a)
        sent_b, full_b = _segment_embeds(tok_b, lb, pointers_b)
