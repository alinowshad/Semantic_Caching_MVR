...
class VCache:
    ...
    def __init__(
        self,
        config: Optional[VCacheConfig] = None,
        ...
        """
        self.vcache_config: VCacheConfig = config if config is not None else VCacheConfig()
        self.vcache_policy: VCachePolicy = policy
        self.vcache_policy.setup(self.vcache_config)
