...
def _build_vcache(*, splitter_checkpoint: str, splitter_device: str, delta: float, candidate_k: int) -> VCache:
...
def _run_loop(
    *,
    ...
    # Warmup (exclude one-time allocations/compilation)
    n = 0
    for r in rows:
        prompt = r["prompt"]
