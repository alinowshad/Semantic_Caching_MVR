...
class AdaptedPointerNetworkPolicy(nn.Module):
    ...
    def __init__(self,   
        ...
        # With a 128-dim backbone (e.g., prajjwal1/bert-tiny), token embeddings should already be
        # [B, T, hidden_dim]. We intentionally do NOT project 768 -> 128 here; enforce instead.
