...
# Default embedding backbone (can be overridden by exporting EMBEDDING_MODEL_NAME before running).
# Using a 128-dim tiny BERT avoids an extra 768 -> 128 projection inside the policy.
os.environ.setdefault("EMBEDDING_MODEL_NAME", "prajjwal1/bert-tiny")
