...
class EmbeddingModel:
    ...
    def __init__(self, model_name=None, device=None):
        # Default backbone:
        # - Prefer explicit user choice via env var, otherwise use bert-base-uncased.
        # This repo previously defaulted to BGE. If you want that behavior, pass
        # model_name explicitly or set EMBEDDING_MODEL_NAME accordingly.
        if model_name is None:
            model_name = os.environ.get("EMBEDDING_MODEL_NAME") or "bert-base-uncased"
